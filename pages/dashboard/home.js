      ...
      <div class="relative p-4 w-full max-w-md h-full md:h-auto">
          <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
              ...
              <div class="py-6 px-6 lg:px-8">
                  <h3 class="mb-2 text-xl font-medium text-gray-900 dark:text-white">Create a Study Deck</h3>
                  ...
                  <form class="space-y-6 " onSubmit={event => handleDeckCreation(event)}>
                      <div>
                          ...
                          <input type="text" id="deck-name" class="bg-gray-50 border border-gray-300 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Name for this deck" onChange={event => setName(event.target.value)}/>
                      </div>
                      <div>
                          <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Deck Description</label>
                          <input type="text" id="deck-description" class="bg-gray-50 border border-gray-300 text-white text-sm rounded-lg block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:text-white" placeholder="A brief description of this deck" onChange={event => setDescription(event.target.value)}/>
                      </div>
                      ...
                      <div>
                          ...
                          <input type="text" id="deck-description" class="bg-gray-50 border border-gray-300 text-white text-sm rounded-lg block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:text-white" onChange={event => handleItemChange(ii.id, event, "term")}/>
                      </div>
                      <div>
                          <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Definition</label>
                          <input type="text" class="bg-gray-50 border border-gray-300 text-white text-sm rounded-lg block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:text-white" onChange={event => handleItemChange(ii.id, event, "definition")}/>
                      </div>
