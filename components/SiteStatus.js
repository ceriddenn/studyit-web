...
const SiteStatus = () => {
  return (
    <section class="flex items-center h-full p-44 overflow-hidden dark:bg-gray-900 dark:text-gray-100">
	<div class="container flex flex-col items-center justify-center px-5 mx-auto my-8 space-y-8 text-center sm:max-w-md">
		...
		<a rel="noopener noreferrer" href="/" class="px-8 py-3 font-semibold rounded dark:bg-violet-400 dark:text-gray-900">Refresh this page?</a>
	</div>
</section>
  )
}
