...
const Header = () => {
  ...
  <a href="https://flowbite.com" class="flex items-center">
      <img src="https://www.volocity.org/wp-content/uploads/2017/01/light-bulb-icon.png" class="mr-3 h-6 sm:h-9" alt="Flowbite Logo" />
      <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white pr-4">StudyIT</span>
      {showLandingAlert &&
<div class="hidden lg:flex p-4 text-sm text-gray-700 bg-gray-100 rounded-lg dark:bg-gray-700 dark:text-gray-300" role="alert">
  ...
  <div className={(dropdown) ? ("justify-between items-center w-full md:flex md:w-auto md:order-1") : ("hidden justify-between items-center w-full md:flex md:w-auto md:order-1")} id="mobile-menu-2">
    <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
      ...
      <li>
        <a href="/studyit?page=home" class={router.pathname == '/studyit' ? "text-1xl font-extrabold block py-2 pr-4 pl-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white" : "text-1xl font-extrabold block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"}>StudyIt</a>
      </li>
      <li>
